...
SETTING_SPECS = {
    ...
    "heuristics_radio": SettingSpec("heuristics", _choice(C.HEURISTICS_LABELS), C.DEFAULT_HEURISTICS),
...
PRESET_KEYS = {"net": "net_select", "selection": "selection_radio", "heuristics": "heuristics_radio", "p": "p_slider", "d": "d_slider", "s": "s_slider", "density": "density_slider",
